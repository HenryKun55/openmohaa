...
#ifdef __vita__
// Inline copy of CM_BoundsIntersect for the per-brush / per-patch rejection tests in the
// trace hot loops (the out-of-line call itself was ~2.4% of the Vita frame).
static ID_INLINE qboolean CM_BoundsIntersectFast( const vec3_t mins, const vec3_t maxs, const vec3_t mins2, const vec3_t maxs2 )
{
